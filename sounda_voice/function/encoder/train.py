...
def train(run_id: str, clean_data_root: Path, function_dir: Path, umap_every: int, save_every: int,
    ...
    state_fpath = function_dir.joinpath(run_id + ".pt")
    backup_dir = function_dir.joinpath(run_id + "_backups")
